  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`${className} absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center w-fit gap-4 rounded-2xl border-neutral-700 border-2`}
        style={{ height: panelHeight, padding: '24px 48px' }}
        role="toolbar"
